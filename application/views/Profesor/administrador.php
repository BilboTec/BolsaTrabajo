...
<ul class="lista_cambios">
	...
	<li ng-click= "establecerConfiguracion(configuraciones.localidades)"><?php echo ucfirst($idioma('localidades')); ?></li>
	...
	<li ng-click= "establecerConfiguracion(configuraciones.idiomas)"><?php echo ucfirst($idioma('idioma')); ?></li>
</ul>
