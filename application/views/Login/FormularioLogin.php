		...
		<fieldset>
			...
			<div class="login-contenedor">
				...
				<input type="hidden" name="tipo" value="{{tipo}}" />
					...
					<div class="error-validacion" ng-show="(formLogin.$submitted || formLogin.email.$touched) && formLogin.email.$error.email"><?php echo printf($idioma("valid_email"),$idioma("email")); ?></div>
					<div class="error-validacion" ng-show="(formLogin.$submitted || formLogin.email.$touched) && formLogin.email.$error.required"><?php echo printf($idioma("required"),$idioma("email"); ?>/div>
				</div>
				<div class="grupo-form">
					...
					<div class="error-validacion" ng-show="(formLogin.$submitted || formLogin.clave.$touched) && formLogin.clave.$invalid"><?php echo printf($idioma("required"),$idioma("clave"); ?></div>
				</div>
