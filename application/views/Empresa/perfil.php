<div ng-controller="controladorDatosEmpresa" name="formPerfil" class="contenedor-perfil contenedor" ng-init='espana=<?php echo json_encode($espana); ?>;empresa=<?php echo json_encode($user); ?>;init()'>
	...
	<form name="formPerfil" ng-show="editando === 2">
		<fieldset>
			...
			<div class="grupo">
				...
				<div class="error_validacion" ng-show="(formPerfil.$submitted || formPerfil.repetirclave.$touched) && usuario.nuevaclave != usuario.repetirclave"><?php printf($idioma("claves_iguales"),$idioma("repetir_clave")); ?></div>
			</div>
			
			<span class="btn btn-tipo" ng-click="cambiarClave()"><?php echo ucfirst($idioma("cambiar")); ?></span>
			<span class="decorado" ng-click="cancelar()"><?php echo ucfirst($idioma("volver")); ?></span>
		</fieldset>
	</form>
</div>